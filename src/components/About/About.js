            ...
            <div className="row">
              ...
              <div className="col-md-9">
                <p className={animate("fadeInRightFast")}>
                  ...
                  at UMichigan Engineering! With graduation less than a year
                  away, I continue to pursue a career in full stack software
                  engineering with a strong interest in web product management.
                </p>
                <p className={animate("fadeInRightFast")}>
                  I enjoy creating side projects during my free time and am
                  always looking for new opportunities to explore. The number of
                  paths to take in engineering are endless, and I'm excited to
                  be a part of this digital world that is transforming our lives
                  everyday.
                </p>
